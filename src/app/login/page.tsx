  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ 
        variant: "destructive", 
        title: "Acesso Negado", 
        description: `Erro: ${error?.code || error?.message || 'Erro desconhecido'}`
      })
    }
  }
      ...
      <div className="w-full max-w-[440px] space-y-8 animate-in fade-in duration-700">
        ...
        <div className="space-y-6">
          ...
          <div className="relative flex items-center">
            <div className="flex-grow border-t border-[#D2D7DB]"></div>
            <span className="flex-shrink-0 mx-4 text-[9px] font-black text-[#98A7AA] uppercase tracking-widest bg-[#F7F7F7] px-2">Acesso Mestre Restrito</span>
            <div className="flex-grow border-t border-[#D2D7DB]"></div>
          </div>
        </div>
