  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#2C4156] text-white overflow-hidden">
      <div className="relative flex flex-col items-center gap-8 animate-in fade-in zoom-in duration-700">
        <div className="relative w-24 h-24 bg-white rounded-3xl shadow-2xl flex items-center justify-center border-4 border-[#2563EB]">
          <TrendingUp className="w-12 h-12 text-[#2C4156]" />
          <div className="absolute -top-2 -right-2 w-6 h-6 bg-[#2563EB] rounded-full flex items-center justify-center animate-bounce shadow-lg">
