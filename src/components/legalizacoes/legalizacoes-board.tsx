...
const AVAILABLE_TAGS: Tag[] = [
  ...
  { name: "Vigilância Sanitária", color: "bg-green-50 text-blue-700 border-green-200 hover:bg-green-100" },
...
const TEAM_MEMBERS = [
  ...
  { id: "u2", name: "Charles Pereira", initials: "CP", color: "bg-blue-600" },
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0 rounded-2xl border-0 shadow-2xl bg-white">
            ...
            <DialogHeader className="w-full">
              <DialogTitle asChild>
                <Input
                  ...
                  className="text-lg font-bold text-slate-800 border-0 border-b-2 border-slate-200 rounded-none px-0 focus-visible:ring-0 focus-visible:border-blue-500 bg-transparent placeholder:text-slate-300"
                />
              </DialogTitle>
            </DialogHeader>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="h-10 border-slate-200 text-xs rounded-xl flex-1 focus-visible:ring-blue-500"
              />
              <Button
                onClick={addCheckItem}
                size="icon"
                className="h-10 w-10 bg-blue-500 hover:bg-blue-600 rounded-xl shrink-0 shadow-sm"
              >
        ...
        <div className="sticky bottom-0 bg-white border-t border-slate-100 px-6 py-4 flex justify-end gap-3 z-10">
          ...
          <Button
            ...
            className="rounded-xl bg-blue-500 hover:bg-blue-600 text-white font-bold text-xs h-10 px-5 gap-2 shadow-sm"
          >
      ...
      >
        ...
        <button
          ...
          className={cn(
            ...
            isCompleted
              ? "border-emerald-300 text-blue-600 bg-emerald-50"
              : "border-slate-200 text-slate-500 hover:text-blue-600 hover:border-emerald-300"
          )}
        >
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              <div className="flex items-center gap-1">
                ...
                <div className="w-10 h-1 bg-slate-100 rounded-full overflow-hidden">
                  <div
                    className={cn("h-full rounded-full transition-all", isCompleted ? "bg-emerald-400" : "bg-blue-500")}
...
export function LegalizacoesBoard() {
  ...
  const stats = [
    ...
    { label: "Concluídos", value: concluded, icon: CheckCircle2, color: "text-blue-600 bg-emerald-50 border-emerald-200" },
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center gap-4">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-9 h-10 border-slate-200 text-xs rounded-xl focus-visible:ring-blue-500 placeholder:text-slate-400"
            value={searchTerm}
        ...
        <div className="flex gap-4 p-1">
              ...
              >
                ...
                <div className="flex items-center justify-between px-1 gap-2">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    ...
                    <button
                      ...
                      className="h-6 w-6 flex items-center justify-center rounded-full bg-white border border-slate-200 text-slate-400 hover:text-blue-600 hover:border-emerald-400 shadow-sm transition-all"
                    >
                ...
                <div className="flex flex-col gap-2.5 flex-1 whitespace-normal">
                  ...
                  {cards.length === 0 && (
                    <button
                      onClick={() => openNew(col.id)}
                      className="flex-1 flex flex-col items-center justify-center gap-2 border-2 border-dashed border-slate-200 rounded-xl text-slate-300 min-h-[140px] hover:border-emerald-300 hover:text-blue-500 hover:bg-emerald-50/5 transition-all group/empty"
                    >
          ...
          <div className="w-[290px] flex-shrink-0 flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white/80 p-4 min-h-[520px] transition-all hover:bg-slate-50">
            <Button
              ...
              className="text-xs font-black uppercase tracking-wider px-4 py-3 rounded-2xl text-slate-600 border-slate-300 hover:border-emerald-400 hover:text-blue-600"
            >
