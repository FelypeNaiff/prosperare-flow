// Teste em JavaScript puro da interpolação das cláusulas societárias do DREI

const formatSocioQualificacao = (socio) => {
...
const getQualificacaoSocios = (socios, empresa) => {
...
const getAlteracaoNomeSede = (empresa) => {
...
const getAlteracaoAtividades = (atividades) => {
...
const getAlteracaoCapitalSocial = (empresa) => {
...
const getContratoSocialConsolidado = (socios, empresa, atividades) => {
  const sociosArr = Array.isArray(socios) ? socios : [socios];
...
const getTitulosContrato = (empresa) => {
...
const socioPriscila = {
  nome: "PRISCILA DUTRA DE MELLO",
  nacionalidade: "brasileira",
  estadoCivil: "solteira",
  dataNascimento: "28/09/1993",
  profissao: "empresária",
  rg: "04076274130",
  orgaoEmissor: "PTC/AP",
  cpf: "040.762.741-30",
  enderecoCompleto: "RAMAL DO ILARIO, S/N, BAIRRO ZONA RURAL, ITAUBAL/AP, CEP 68976-000"
};

const empresaPriscila = {
  razaoSocialAntiga: "52.002.925 PRISCILA DUTRA DE MELLO",
  novaRazaoSocial: "RANCHO BONANZA LTDA",
  novoNomeFantasia: "RANCHO BONANZA",
  enderecoSede: "RAMAL DO ILARIO, S/N, BAIRRO ZONA RURAL, ITAUBAL/AP, CEP 68976-000",
  cnpj: "52.002.925/0001-75",
  capitalAntigo: "R$20.000,00",
  capitalAntigoExtenso: "vinte mil reais",
  novoCapital: "R$ 425.000,00",
  novoCapitalExtenso: "quatrocentos e vinte e cinco mil reais",
  distribuicaoQuotas: [
    { nome: "PRISCILA DUTRA DE MELLO", quotas: "425.000", valor: "R$425.000,00" }
  ],
  dataInicioAtividades: "29/08/2023",
  foroCidade: "Macapá - AP",
  cidadeData: "Macapá-AP",
  dataAssinatura: "05 de agosto de 2026"
};

const atividades = [
  { codigo: "1063500", descricao: "FABRICACAO DE FARINHA DE MANDIOCA E DERIVADOS" },
  { codigo: "0322101", descricao: "CRIACAO DE PEIXES EM AGUA DOCE" },
  { codigo: "1032599", descricao: "FABRICACAO DE CONSERVAS DE LEGUMES E OUTROS VEGETAIS, EXCETO PALMITO" },
  { codigo: "4633801", descricao: "COMERCIO ATACADISTA DE FRUTAS, VERDURAS, RAIZES, TUVERCULOS, HORTALICAS E LEGUMES" }
];

console.log("=== TESTE DA CLÁUSULA QUINTA ===");
console.log(getContratoSocialConsolidado(socioPriscila, empresaPriscila, atividades).split("DO CAPITAL SOCIAL")[1].split("DA ADMINISTRAÇÃO")[0]);
